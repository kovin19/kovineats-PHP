            ...
            <div class="container-fluid">
                ...
                <div class="btn-group btn-group-lg" role="group">
                    <button type="button" class="btn btn-primary d-flex justify-content-end" 
                        data-mdb-toggle="modal" data-mdb-toggle="modal" data-mdb-target="#modalCarrito" onclick="calcularTotal()">
                        <i class="fas fa-shopping-cart"></i>
                        <span class="badge rounded-pill badge-notification bg-danger">0</span>
                    </button>
                    
                    <a type="button" href="" class="btn btn-primary d-flex justify-content-end" aria-label="Ver pedidos"><i class="fas fa-receipt"></i></a>
                </div>
            </div>
        </nav>
                                                        ...
                                                        <div class="col-4">
                                                            <div>
                                                                ...
                                                                <div class="form-check" id="checkes">
                                                                    <input name="ingredientes" class="form-check-input" type="checkbox" value="1"/>
                                                                    <label class="form-check-label" for="1">Pepperoni</label>
                                                                </div>
                                                        </div>
                                                    </div>
                                                    <hr>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                                    <div class="row" style="margin-right:5%;">
                                        <div class="col">
                                            <img src="https://i.ibb.co/74JpfR5/pizza.png" class="img-thumbnail" width="70%" height="70%" alt="platillo">
                                        </div>
                                        <div class="col align-self-md-center">
                                            <p></p>
                                        </div>
                                        <div class="col align-self-md-center">
                                            <p class="d-flex flex-row-reverse" name="preciosCarrito" data-precio="">$130.00</p>
